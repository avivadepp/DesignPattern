...
public class AppleLamda {
    ...
    public static void main(String[] args) {
        ...
        apples.add(a3);
        //lamda表达式语法为参数->主体
        List<Apple> greenApples = filterApplesByStrategy(apples, (Apple apple) -> Colour.GREEN.equals(apple.getColor()));
        List<Apple> roundApples = filterApplesByStrategy(apples, (Apple apple) -> Shape.ROUND.equals(apple.getShape()));
